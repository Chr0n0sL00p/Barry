package com.example.barry.notification
...
import com.example.barry.MainActivity
import com.example.barry.R

class NotificationHelper(private val context: Context) {

    companion object {
        private const val CHANNEL_ID = "barry_alerts_channel"
